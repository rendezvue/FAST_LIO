...
void Preprocess::process(const sensor_msgs::msg::PointCloud2::UniquePtr &msg, PointCloudXYZI::Ptr& pcl_out)
{
  ...
  switch (lidar_type)
  {
    ...
    case MID360_XYZR:
      mid360_xyzr_handler(msg);
      break;

    case MID360_XYZI:
      mid360_xyzi_handler(msg);
      break;
...
void Preprocess::mid360_xyzr_handler(const sensor_msgs::msg::PointCloud2::UniquePtr &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
...
void Preprocess::mid360_xyzi_handler(const sensor_msgs::msg::PointCloud2::UniquePtr &msg)
{
  pl_surf.clear();
  pl_corn.clear();
  pl_full.clear();
